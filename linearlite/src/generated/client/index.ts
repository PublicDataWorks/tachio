...
export const IssuesScalarFieldEnumSchema = z.enum(['id','title','description','modified','created','kanbanorder','username','external_urls','completed_at','status','priority','updated_at','project_id']);
