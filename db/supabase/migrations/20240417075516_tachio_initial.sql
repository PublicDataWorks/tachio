...
create table "public"."org_emails" (
    "created_at" timestamp with time zone not null default now(),
...
alter table "public"."org_emails" enable row level security;
...
CREATE UNIQUE INDEX emails_email_address_key ON public.emails USING btree (email_address);
...
CREATE UNIQUE INDEX org_emails_pkey ON public.org_emails USING btree (org_id, email_id);

CREATE UNIQUE INDEX org_slack_channels_pkey ON public.org_slack_channels USING btree (org_id, slack_channel_id);

CREATE UNIQUE INDEX orgs_name_key ON public.orgs USING btree (name);

CREATE UNIQUE INDEX partners_pkey ON public.orgs USING btree (id);

CREATE UNIQUE INDEX partners_shortname_key ON public.orgs USING btree (shortname);

CREATE UNIQUE INDEX pivotal_tracker_webhooks_pkey ON public.pivotal_tracker_webhooks USING btree (id);

CREATE UNIQUE INDEX projects_linear_team_id_unique ON public.projects USING btree (linear_team_id);

CREATE UNIQUE INDEX projects_name_unique ON public.projects USING btree (name);
...
alter table "public"."org_emails" add constraint "org_emails_pkey" PRIMARY KEY using index "org_emails_pkey";
...
alter table "public"."orgs" add constraint "partners_pkey" PRIMARY KEY using index "partners_pkey";
...
alter table "public"."emails" add constraint "emails_email_address_key" UNIQUE using index "emails_email_address_key";

alter table "public"."org_emails" add constraint "public_org_emails_email_id_fkey" FOREIGN KEY (email_id) REFERENCES public.emails(id) ON DELETE CASCADE not valid;

alter table "public"."org_emails" validate constraint "public_org_emails_email_id_fkey";

alter table "public"."org_emails" add constraint "public_org_emails_org_id_fkey" FOREIGN KEY (org_id) REFERENCES public.orgs(id) ON DELETE CASCADE not valid;

alter table "public"."org_emails" validate constraint "public_org_emails_org_id_fkey";
...
alter table "public"."orgs" add constraint "orgs_name_key" UNIQUE using index "orgs_name_key";

alter table "public"."orgs" add constraint "partners_shortname_key" UNIQUE using index "partners_shortname_key";

alter table "public"."orgs" add constraint "public_orgs_primary_email_address_fkey" FOREIGN KEY (primary_email_address) REFERENCES public.emails(email_address) ON DELETE SET NULL not valid;
...
alter table "public"."projects" add constraint "projects_linear_team_id_unique" UNIQUE using index "projects_linear_team_id_unique";

alter table "public"."projects" add constraint "projects_name_unique" UNIQUE using index "projects_name_unique";
...
grant insert on table "public"."org_emails" to "service_role";

grant references on table "public"."org_emails" to "service_role";

grant select on table "public"."org_emails" to "service_role";

grant trigger on table "public"."org_emails" to "service_role";

grant truncate on table "public"."org_emails" to "service_role";
