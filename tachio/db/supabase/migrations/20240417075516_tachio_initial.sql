...
create table "public"."org_secondary_emails" (
    "created_at" timestamp with time zone not null default now(),
...
alter table "public"."org_secondary_emails" enable row level security;
...
CREATE UNIQUE INDEX org_secondary_emails_pkey ON public.org_secondary_emails USING btree (org_id, email_id);
...
alter table "public"."org_secondary_emails" add constraint "org_secondary_emails_pkey" PRIMARY KEY using index "org_secondary_emails_pkey";
...
alter table "public"."org_secondary_emails" add constraint "public_org_secondary_emails_email_id_fkey" FOREIGN KEY (email_id) REFERENCES public.emails(id) ON DELETE CASCADE not valid;

alter table "public"."org_secondary_emails" validate constraint "public_org_secondary_emails_email_id_fkey";

alter table "public"."org_secondary_emails" add constraint "public_org_secondary_emails_org_id_fkey" FOREIGN KEY (org_id) REFERENCES public.orgs(id) ON DELETE CASCADE not valid;

alter table "public"."org_secondary_emails" validate constraint "public_org_secondary_emails_org_id_fkey";
...
grant delete on table "public"."org_secondary_emails" to "service_role";

grant insert on table "public"."org_secondary_emails" to "service_role";

grant references on table "public"."org_secondary_emails" to "service_role";

grant select on table "public"."org_secondary_emails" to "service_role";

grant trigger on table "public"."org_secondary_emails" to "service_role";

grant truncate on table "public"."org_secondary_emails" to "service_role";

grant update on table "public"."org_secondary_emails" to "service_role";
